...
builder.Services.AddOptions();
builder.Services.Configure<GoogleCredentialSettings>(builder.Configuration.GetSection("GoogleCredential"));
...
builder.Services.AddSingleton<CustomIdentityErrorDescriber>();
...
//Added Authorization middleware for checking Technician's functions
