$(document).ready(function () {
    ...
    $('#sortBtn').click(function () {
        ...
        if (searchName.length > 60) {
            document.getElementById("search-toast").innerHTML = 'Tên của nhóm không được nhiều hơn 60 kí tự ';
        ...
        $.ajax({
            ...
            success: (data) => {
                ...
                if (data && data.length > 0) {
                    ...
                    $('#content-form').html('<h2>Không có nhóm nào trong trang trại này</h2>');
                    $('#pagi-pages').html('');
                }
            },
            error: function () {
    ...
    $("table").on("click", ".updateffff", function (e) {
        e.stopPropagation();
        var resId = e.target.closest("tr").id;
        resId = resId.slice(9);
