...
function Update() {
    ...
    if (name === null || name.length === 0) {
        ...
        document.getElementById("name-toast").innerHTML = 'Tên của nhóm không được nhiều hơn 60 kí tự ';
    ...
    if (description.length > 180) {
        document.getElementById("description-toast").innerHTML = 'Miêu tả nhóm không được nhiều hơn 180 kí tự ';
...
function Create() {
    ...
    if (name === null || name.length === 0) {
        ...
        document.getElementById("name2-toast").innerHTML = 'Tên của nhóm không được nhiều hơn 60 kí tự ';
    ...
    if (description.length > 180) {
        document.getElementById("description2-toast").innerHTML = 'Miêu tả nhóm không được nhiều hơn 180 kí tự ';
    ...
    data.forEach(element => {
        ...
        dataGrid +=
            `
                                        ...
                                        <td>${element.name}</td>
                                        <td style="width: 50%;">${element.description}</td>
                                <td hidden>${formattedDate}</td>
                                <td>${statusLabel}</td>
                                <td style="padding-left: 8%;"><button style='background-color: transparent;border: none; padding: 5px; cursor: pointer' class='updateffff btn btn-secondary btn-sm detailBtn'><i class="mdi mdi-eye user-icon"></i></button>
                                </td>
                                <td>
